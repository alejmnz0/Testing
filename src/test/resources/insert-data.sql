insert into types (id, name) values (7, 'Pitbull');
insert into types (id, name) values (8, 'Mastin');
insert into types (id, name) values (9, 'Labrador');
insert into types (id, name) values (10, 'Galgo');

INSERT INTO owners VALUES (11, 'Nono', 'Loco', 'Museo', 'Madison', '6085951023') ON CONFLICT DO NOTHING;
INSERT INTO owners VALUES (12, 'PepeIllo', 'Pepillo', 'Pepeillo', 'Sun Prairie', '6085556749') ON CONFLICT DO NOTHING;
INSERT INTO owners VALUES (13, 'Eduardo', 'Malamadre', 'La Publica', 'McFarland', '6085658763') ON CONFLICT DO NOTHING;
INSERT INTO owners VALUES (14, 'Miguel', 'El Films', 'Triana', 'Windsor', '6085554198') ON CONFLICT DO NOTHING;

insert into Pets (id, name, birth_date, type_id, owner_id) values (14, 'Zarla', '2024-01-13', 7, 11);
insert into Pets (id, name, birth_date, type_id, owner_id) values (15, 'Yorgos', '2023-07-14', 8, 12);
insert into Pets (id, name, birth_date, type_id, owner_id) values (16, 'Anatole', '2023-10-09', 9, 13);
insert into Pets (id, name, birth_date, type_id, owner_id) values (17, 'Corabel', '2023-11-18', 10, 14);
insert into Pets (id, name, birth_date, type_id, owner_id) values (18, 'Johann', '2023-12-05', 7, 14);

insert into visits (id, visit_date, description, pet_id) values (5, '2023-03-15', 'stjxonlujhsqiqzpgvzfzuajtfbwomgqbhthcvwtdoaerf', 14);
insert into visits (id, visit_date, description, pet_id) values (6, '2023-10-14', 'enyvssqcwzwsaqkwwiuzijdkyueccthxxyidvfeprmygzn', 15);
insert into visits (id, visit_date, description, pet_id) values (7, '2023-09-24', 'bkhvicdjequgtztoqruoqzxlkvteftvctrgpkgiijchsjr', 16);
insert into visits (id, visit_date, description, pet_id) values (8, '2023-05-18', 'xqjnzwclbqlvnpjwxrbwidqzwyldqspdnehswxgaehbguz', 17);
insert into visits (id, visit_date, description, pet_id) values (9, '2023-09-08', 'xbofrpdzwkqopexrvdpsroionlyujbjgkgkkltymyvpvmg', 18);
